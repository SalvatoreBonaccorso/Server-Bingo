...
describe("vogliamo testare l'estrazione", function() {
    ...
    it('voglio verificare il corretto funzionamento di numbers con un number', function(done) {
        //request simula il comportamento di una chiamata API
        request(app)
        .get('/numbers/4')
        .expect(200) // verifico lo status
    ...
    it('voglio verificare il corretto funzionamento di numbers con stringa', function(done) {
        //request simula il comportamento di una chiamata API
        request(app)
        .get('/numbers/pippo')
    ...
    it('voglio verificare il corretto funzionamento di numbers con array', function(done) {
        //request simula il comportamento di una chiamata API
        request(app)
        .get('/numbers')
        .expect(200) // verifico lo status
